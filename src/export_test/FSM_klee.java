...
public class FSM_klee
{

// line 13 "tmp_actions.rl"




// line 11 "FSM_klee.java"
...
{
	r[0]=43; r[1]=45; r[2]=46; r[3]=48; r[4]=57; r[5]=46; r[6]=48; r[7]=57; 
	r[8]=48; r[9]=57; r[10]=0; 
}
...
{
	r[0]=1; r[1]=1; r[2]=2; r[3]=3; r[4]=0; r[5]=0; r[6]=2; r[7]=3; 
	r[8]=0; r[9]=4; r[10]=0; r[11]=0; 
}
...
static final int klee_start = 0;
static final int klee_first_final = 4;
static final int klee_error = -1;

static final int klee_en_main = 0;
...
// line 169 "FSM_klee.java"
	{
	cs = klee_start;
	}
// line 30 "tmp_actions.rl"
  
// line 175 "FSM_klee.java"
	{
	int _klen;
	int _trans;
	int _acts;
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
// line 8 "tmp_actions.rl"
	{ res = 1; }
	break;
	case 1:
// line 9 "tmp_actions.rl"
	{ res = 0; }
	break;
// line 255 "FSM_klee.java"
		}
	}
